...
image:https://badge.waffle.io/FunThomas424242/jmockit.example.svg?columns=all["Waffle.io - Columns and their card count", link="https://github.com/FunThomas424242/jmockit.example/projects/1"]
